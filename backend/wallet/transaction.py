...
class Transaction:
    ...
    def create_output(self, sender_wallet, receipient, amount):
        """
    ...
    def create_input(self, sender_wallet, output):
        """
        Structure the input data for the transacion.
        Sign the transaction and include the sender's public
        key and address.
        """
        return {
    ...
    def update(self, sender_wallet, recipient, amount):
        ...
        if amount > self.output[sender_wallet.address]:
            raise Exception('Amount exceeds balance')
        # Checking if the recipient is already in the output
...
def main():
    ...
    print(f'\n--transacation.__dict__: {transaction.__dict__}')
