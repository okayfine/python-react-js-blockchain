...
# testing how the addition of blocks works
def test_add_block():
    blockchain = Blockchain()
    data = 'test-data'
...
def blockchain_three_blocks():
    ...
    for i in range(3):
        ...
        # Above created chain for testing
        return blockchain
...
def test_replcae_chain_not_longer(blockchain_three_blocks):
    blockchain = Blockchain()
...
def test_is_valid_transaction_chain_duplicate_transactions(blockchain_three_blocks):
    ...
    # adding two duplicate transactions
